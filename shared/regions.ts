...
export const REGIONS: RegionInfo[] = [
  ...
  { region: 'EU-West', label: 'EU West', metro: 'London', host: 'ec2.eu-west-2.amazonaws.com', port: 443 },
  { region: 'EU-Central', label: 'EU Central', metro: 'Frankfurt', host: 'ec2.eu-central-1.amazonaws.com', port: 443 },
  { region: 'Asia-East', label: 'Asia East', metro: 'Tokyo', host: 'ec2.ap-northeast-1.amazonaws.com', port: 443 },
  { region: 'Asia-Korea', label: 'Korea', metro: 'Seoul', host: 'ec2.ap-northeast-2.amazonaws.com', port: 443 },
  { region: 'Asia-SE', label: 'Asia SE', metro: 'Singapore', host: 'ec2.ap-southeast-1.amazonaws.com', port: 443 },
